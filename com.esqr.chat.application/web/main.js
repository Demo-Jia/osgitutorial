...
(function() {
	...
	var MODULE = angular.module('com.esqr.chat',
			[ 'ngRoute', 'ngResource' ]);

	MODULE.config( function($routeProvider) {
		$routeProvider.when('/', { controller: mainProvider, templateUrl: '/com.esqr.chat/main/htm/home.htm'});
		$routeProvider.when('/about', { templateUrl: '/com.esqr.chat/main/htm/about.htm'});
